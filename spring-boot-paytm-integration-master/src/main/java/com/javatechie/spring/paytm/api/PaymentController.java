	...
	public String home() {
	 ...
	 @PostMapping(value = "/pgredirect")
	    public ModelAndView getRedirect(@RequestParam(name = "CUST_ID") String customerId,
	        ...
	        ModelAndView modelAndView = new ModelAndView("redirect:" + paytmDetails.getPaytmUrl());//redirecting modelview object to details to paytm
	        TreeMap<String, String> parameters = new TreeMap<>();
	        paytmDetails.getDetails().forEach((k, v) -> parameters.put(k, v));//getting all details from paytmDetails model class and saved into treeMap
